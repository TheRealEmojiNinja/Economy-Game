...
Version 1.0.2 should create maximum limits for the number of factories, mines and infrastructure a unique province can have:
...
However, these values are dependent upon the terrain characteristics of the province.
